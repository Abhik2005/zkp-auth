...
/** Lock icon (Heroicons outline style) */
...
/** Key icon (Heroicons outline style) */
...
/** Shield check icon (Heroicons outline style) */
...
/** Clipboard icon (Heroicons outline style) */
export function ClipboardIcon({ className }: IconProps): JSX.Element {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
